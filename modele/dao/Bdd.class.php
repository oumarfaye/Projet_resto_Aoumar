...
class Bdd {
    ...
    private static $login = "glepissier";   // login utilisateur de la BDD
    private static $mdp = "KOlzr5f6";         // mdp  utilisateur de la BDD
    private static $bd = "glepissier_resto";          // nom de la BDD
